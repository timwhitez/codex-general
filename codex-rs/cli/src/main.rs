...
fn profile_v2_for_subcommand<'a>(
    ...
    match subcommand {
        ...
        _ => anyhow::bail!(
            "--profile only applies to runtime commands and `codex-general mcp`: `codex-general`, `codex-general exec`, `codex-general review`, `codex-general resume`, `codex-general fork`, `codex-general mcp`, `codex-general sandbox`, and `codex-general debug prompt-input`."
        ),
    }
}
...
/// Merge flags provided to `codex-general resume`/`codex-general fork` so they take precedence over any
