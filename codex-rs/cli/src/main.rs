...
fn profile_v2_for_subcommand<'a>(
    ...
    match subcommand {
        ...
        _ => anyhow::bail!(
            "--profile only applies to runtime commands: `codex-general`, `codex-general exec`, `codex-general review`, `codex-general resume`, `codex-general fork`, and `codex-general debug prompt-input`."
        ),
    }
}
