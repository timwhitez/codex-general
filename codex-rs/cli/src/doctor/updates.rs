...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/timwhitez/codex-general/releases/latest";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g codex-general",
        InstallMethod::Bun => "bun install -g codex-general",
