...
#[derive(Debug, Parser)]
#[command(bin_name = "codex-general plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-general plugin marketplace add",
    after_help = "Examples:\n  codex-general plugin marketplace add ./path/to/marketplace\n  codex-general plugin marketplace add owner/repo --ref main\n  codex-general plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-general plugin marketplace upgrade",
    after_help = "Examples:\n  codex-general plugin marketplace upgrade\n  codex-general plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codex-general plugin marketplace remove",
    after_help = "Example:\n  codex-general plugin marketplace remove debug"
)]
