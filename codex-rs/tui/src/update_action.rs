...
pub enum UpdateAction {
    /// Update via `npm install -g codex-general@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g codex-general@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "codex-general"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "codex-general"]),
