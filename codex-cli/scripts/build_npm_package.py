#!/usr/bin/env python3
"""Stage and optionally package the codex-general npm module."""
...
CODEX_NPM_NAME = "codex-general"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `codex-general`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-general-linux-x64": {
        "npm_name": "codex-general-linux-x64",
        "npm_tag": "linux-x64",
        "target_triple": "x86_64-unknown-linux-musl",
        "os": "linux",
        "cpu": "x64",
    },
    "codex-general-linux-arm64": {
        "npm_name": "codex-general-linux-arm64",
        "npm_tag": "linux-arm64",
        "target_triple": "aarch64-unknown-linux-musl",
        "os": "linux",
        "cpu": "arm64",
    },
    "codex-general-darwin-x64": {
        "npm_name": "codex-general-darwin-x64",
        "npm_tag": "darwin-x64",
        "target_triple": "x86_64-apple-darwin",
        "os": "darwin",
        "cpu": "x64",
    },
    "codex-general-darwin-arm64": {
        "npm_name": "codex-general-darwin-arm64",
        "npm_tag": "darwin-arm64",
        "target_triple": "aarch64-apple-darwin",
        "os": "darwin",
        "cpu": "arm64",
    },
    "codex-general-win32-x64": {
        "npm_name": "codex-general-win32-x64",
        "npm_tag": "win32-x64",
        "target_triple": "x86_64-pc-windows-msvc",
        "os": "win32",
        "cpu": "x64",
    },
    "codex-general-win32-arm64": {
        "npm_name": "codex-general-win32-arm64",
        "npm_tag": "win32-arm64",
...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "codex-general": ["codex-general", *CODEX_PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "codex-general": [],
    "codex-general-linux-x64": [CODEX_PACKAGE_COMPONENT],
    "codex-general-linux-arm64": [CODEX_PACKAGE_COMPONENT],
    "codex-general-darwin-x64": [CODEX_PACKAGE_COMPONENT],
    "codex-general-darwin-arm64": [CODEX_PACKAGE_COMPONENT],
    "codex-general-win32-x64": [CODEX_PACKAGE_COMPONENT],
    "codex-general-win32-arm64": [CODEX_PACKAGE_COMPONENT],
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Which npm package to stage (default: codex-general).",
    )
    parser.add_argument(
        "--version",
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex-general":
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["codex-general"]
            if platform_package != "codex-general"
        }
...
def validate_codex_package_dir(package_dir: Path) -> None:
    ...
    required_files = [
        ...
        Path("bin") / ("codex-general.exe" if is_windows else "codex-general"),
